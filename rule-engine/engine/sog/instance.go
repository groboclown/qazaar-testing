...
func (s *SogInstance) AddMember(o *obj.EngineObj) {
	if s == nil || o == nil {
		return
	}
	if s.sealed {
...
func (s *SogInstance) Seal(factory obj.ObjFactory, groupId string) *obj.EngineObj {
	if s == nil {
		return nil
	}
	s.sealed = true
	...
	if s.instance == nil {
		s.instance = factory.FromGroup(s.members, groupId)
	}
	return s.instance
}

func (s *SogInstance) Sealed() bool {
	return s.sealed
}
...
func (s *SogInstance) matches(shared map[string]obj.DescriptorValues) bool {
